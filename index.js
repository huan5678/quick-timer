...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, audioEnd, newAudio, soundToggle, show, getTimeToEnd, adjust, adjustRange, toggle, reset, blink, updateProgressBar, count, run, resize;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
getTimeToEnd = function(range){
  var now, end, currentDay, daysToSunday;
  now = new Date();
  end = null;
  switch (range) {
  case 'today':
